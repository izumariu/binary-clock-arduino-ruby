module Gem
  ...
  ConfigMap = {:ruby_version=>"2.3.0", :arch=>"x86_64-linux-gnu"}
  ...
  LOADED_SPECS_MUTEX = #<Thread::Mutex:0x000000024f1508>
  ...
  RUBYGEMS_DIR = "/usr/lib/ruby/2.3.0"
  ...
  RubyGemsPackageVersion = "2.5.1"
  RubyGemsVersion = "2.5.1"
